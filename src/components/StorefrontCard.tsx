...
import SubscriptionPreferencesModal from './SubscriptionPreferencesModal'
...
const StorefrontCard = ({ storefront }: Props) => {
    ...
    //     }
    // }
    const handleOpenSubscribeModal = (e: React.MouseEvent) => {
        e.preventDefault()
        e.stopPropagation()
        setIsModalOpen(true)
    }
                ...
                <div className="flex h-full flex-col gap-4 p-6">
                    ...
                    {isBuyer && !isChecking && (
                        <button
                            ...
                            onClick={isSubscribed ? handleUnsubscribe : handleOpenSubscribeModal}
                            disabled={isLoading}
                            className={`btn-pill w-full text-sm font-semibold ${isSubscribed
                                ? 'btn-outline'
                                : 'btn-primary'
                                } disabled:opacity-50 disabled:cursor-not-allowed`}
                        >
